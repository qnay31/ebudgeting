...
$unik     = $_GET["id_unik"];
$query    = mysqli_query($conn, "SELECT * FROM laporan_media WHERE id = '$unik'");
...
// die(var_dump($hapus));
$query2 = mysqli_query($conn, "DELETE FROM `laporan_media` WHERE id = '$unik' AND nama_akun = '$nama_akun' ");
