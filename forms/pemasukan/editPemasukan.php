...
if ($incomeId == "") {
    $q3  = mysqli_query($conn, "SELECT * FROM 2022_income WHERE id_pengurus = '$_SESSION[id_pengurus]' AND `posisi` = '$_SESSION[posisi]' AND status = 'Menunggu Verifikasi' AND id = '$unik' AND MONTH(tgl_pemasukan) = '$periode' ORDER BY `tgl_pemasukan` DESC");
